...
class TestMetadataExtractorExtract:
    ...
    async def test_extract_with_no_title_tag(self):
    ...
    async def test_extract_with_empty_title_tag(self):
    ...
    async def test_extract_strips_whitespace_from_title(self):
    ...
    async def test_extract_url_slug_for_homepage(self):
    ...
    async def test_extract_raises_processing_error_on_exception(self):
        ...
        with pytest.raises(ProcessingError, match="Failed to extract metadata"):
            await extractor.extract(None)  # Invalid soup causes exception
...
class TestMetadataExtractorExtractMetaDescription:
    ...
    async def test_extract_meta_description_from_standard_meta_tag(self):
    ...
    async def test_extract_meta_description_from_opengraph(self):
    ...
    async def test_extract_meta_description_from_twitter(self):
    ...
    async def test_extract_meta_description_priority_order(self):
    ...
    async def test_extract_meta_description_strips_whitespace(self):
    ...
    async def test_extract_meta_description_returns_default_when_not_found(self):
...
class TestMetadataExtractorExtractPublishedDate:
    ...
    async def test_extract_published_date_from_article_published_time(self):
    ...
    async def test_extract_published_date_from_time_datetime(self):
    ...
    async def test_extract_published_date_from_wordpress_class(self):
    ...
    async def test_extract_published_date_from_schema_org_microdata(self):
    ...
    async def test_extract_published_date_strips_whitespace(self):
    ...
    async def test_extract_published_date_returns_default_when_not_found(self):
...
class TestMetadataExtractorSupportsUrl:
    ...
    def test_supports_url_returns_true_for_same_domain(self):
    ...
    def test_supports_url_returns_false_for_different_domain(self):
    ...
    def test_supports_url_handles_subdomain_differences(self):
    ...
    def test_supports_url_ignores_path_differences(self):
