...
class TestPriority2Integration:
    ...
    async def test_batch_with_config_and_caching(self, temp_dir):
        ...
        # Load configuration
        converter_config, batch_config = ConfigLoader.create_converter_config(config_data), ConfigLoader.create_batch_config(config_data)
    ...
    def test_config_generation_and_loading_cycle(self, temp_dir):
        ...
        assert yaml_data['converter']['default_timeout'] == json_data['converter']['default_timeout']
...
"""
    ...
    async def test_full_pipeline_simulation(self, temp_dir):
        ...
        cached_html = "<html><body><h1>Cached Content</h1><p>This was cached before.</p></body></html>"
    ...
    def test_priority2_feature_compatibility(self):
        ...
        full_config = {
            'converter': {
                ...
                'respect_robots_txt': True,
                'preserve_classes': [
                    'wp-block', 'custom-class', 'shopify-compatible'
                ]
            },
            'batch': {
                'max_concurrent': 4,
