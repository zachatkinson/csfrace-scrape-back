...
class TestAsyncWordPressConverter:
    ...
    async def test_converter_initialization(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter(
            base_url="https://test.example.com/blog/post", output_dir=temp_dir
        )
    ...
    async def test_directory_setup(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter(
            "https://test.example.com", temp_dir / "conversion_output"
        )
    ...
    async def test_complete_conversion_pipeline(self, temp_dir: Path, sample_html: str):
        ...
        converter = AsyncWordPressConverter("https://test.example.com/blog/post", temp_dir)
    ...
    async def test_fetch_error_handling(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter("https://nonexistent.example.com/blog/post", temp_dir)
    ...
    async def test_timeout_handling(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter("https://slow.example.com/blog/post", temp_dir)
    ...
    async def test_robots_txt_integration(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter("https://test.example.com/blocked/content", temp_dir)
    ...
    async def test_large_content_handling(self, temp_dir: Path):
        ...
        converter = AsyncWordPressConverter("https://test.example.com/large-content", temp_dir)
        ...
        with patch("aiohttp.ClientSession") as mock_session_class:
            ...
            mock_session.get.return_value.__aenter__.side_effect = [main_response] + [
                image_response
            ] * 50
