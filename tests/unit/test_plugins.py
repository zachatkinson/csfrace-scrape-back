...
from src.plugins.base import (
    BasePlugin, PluginConfig, PluginType,
    HTMLProcessorPlugin, ContentFilterPlugin, MetadataExtractorPlugin
)
from src.plugins.registry import PluginRegistry
from src.plugins.manager import PluginManager, PluginExecutionContext
...
class TestPluginRegistry:
    ...
    def test_list_plugins(self, registry):
        ...
        config1 = PluginConfig(
            ...
            plugin_type=PluginType.HTML_PROCESSOR, priority=10
        )
        config2 = PluginConfig(
            name="Plugin2", version="1.0.0",
            plugin_type=PluginType.CONTENT_FILTER, priority=20
        )
        config3 = PluginConfig(
            name="Plugin3", version="1.0.0",
            plugin_type=PluginType.HTML_PROCESSOR, priority=5, enabled=False
        )
