...
class TestConfigLoader:
    ...
    def test_create_converter_config_default(self):
        ...
        config_dict = {
            "converter": {"default_timeout": 60, "max_retries": 5, "user_agent": "Custom-Agent/2.0"}
        }
    ...
    def test_create_converter_config_with_base(self):
        ...
        base_config = ConverterConfig(
            default_timeout=30, max_retries=2, user_agent="Base-Agent/1.0"
        )
    ...
    def test_create_batch_config_default(self):
        ...
        config_dict = {
            "batch": {"max_concurrent": 8, "timeout_per_job": 600, "create_archives": True}
        }
    ...
    def test_create_batch_config_with_path_conversion(self):
        ...
        config_dict = {"batch": {"output_base_dir": "/custom/output/path"}}
