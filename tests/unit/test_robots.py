...
class TestRobotsChecker:
    ...
    @pytest.mark.unit
    async def test_robots_parser_caching(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
    ...
    @pytest.mark.unit
    async def test_robots_not_found(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
    ...
    @pytest.mark.unit
    async def test_can_fetch_allowed(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        # Test allowed URL
        can_fetch = await robots_checker_instance.can_fetch("https://example.com/public/page", "*", mock_session)
        assert can_fetch is True
        
        # Test general allowed URL
        can_fetch = await robots_checker_instance.can_fetch("https://example.com/blog/post", "*", mock_session)
        assert can_fetch is True
    
    @pytest.mark.unit
    async def test_can_fetch_disallowed(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        # Test disallowed URL
        can_fetch = await robots_checker_instance.can_fetch("https://example.com/admin/panel", "*", mock_session)
        assert can_fetch is False
    
    @pytest.mark.unit
    async def test_can_fetch_no_robots(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        can_fetch = await robots_checker_instance.can_fetch("https://example.com/anything", "*", mock_session)
        assert can_fetch is True
    
    @pytest.mark.unit
    async def test_get_crawl_delay_specified(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        delay = await robots_checker_instance.get_crawl_delay("https://example.com/page", "*", mock_session)
        assert delay == 5.0
    
    @pytest.mark.unit
    async def test_get_crawl_delay_default(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
    ...
    @pytest.mark.unit
    async def test_get_crawl_delay_no_robots(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
    ...
    @pytest.mark.unit
    async def test_enforce_crawl_delay_timing(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
    ...
    @pytest.mark.unit
    async def test_check_and_delay_blocked(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        with pytest.raises(RateLimitError, match="blocked by robots.txt"):
            await robots_checker_instance.check_and_delay("https://example.com/blocked/page", "*", mock_session)
    
    @pytest.mark.unit
    async def test_check_and_delay_allowed(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        await robots_checker_instance.check_and_delay("https://example.com/allowed/page", "*", mock_session)
    ...
    @pytest.mark.unit
    async def test_robots_fetch_retry_logic(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        parser1 = await robots_checker_instance.get_robots_parser("https://example.com", mock_session)
        assert parser1 is not None
        ...
        parser2 = await robots_checker_instance.get_robots_parser("https://example.com", mock_session)
    ...
    @pytest.mark.unit
    async def test_user_agent_specific_rules(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
...
Disallow: /
        ...
        can_fetch_general = await robots_checker_instance.can_fetch(f"{url}/general/page", "*", mock_session)
        ...
        can_fetch_google = await robots_checker_instance.can_fetch(f"{url}/general/page", "Googlebot", mock_session)
        assert can_fetch_google is True  # Not blocked for Googlebot
        
        can_fetch_google_blocked = await robots_checker_instance.can_fetch(f"{url}/google-blocked/page", "Googlebot", mock_session)
        ...
        can_fetch_badbot = await robots_checker_instance.can_fetch(f"{url}/anything", "BadBot", mock_session)
        assert can_fetch_badbot is False
    
    @pytest.mark.unit
    async def test_robots_disabled(self, robots_checker_instance: RobotsChecker, mock_session: AsyncMock):
        ...
        with patch('src.utils.robots.config') as mock_config:
            ...
            delay = await robots_checker_instance.get_crawl_delay("https://example.com", "*", mock_session)
            assert delay == 0.5
            assert mock_session.get.call_count == 0