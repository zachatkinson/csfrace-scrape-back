...
def apply_systematic_fixes():
    ...
    # src.auth.router.get_webauthn_service should be
    # src.auth.dependencies.get_webauthn_service
    content = re.sub(
    ...
    # Fix 2: All @patch decorators that reference
    # src.auth.router.get_passkey_manager should be
    # src.auth.dependencies.get_passkey_manager
    content = re.sub(
