...
# Module-level challenge storage shared across all service instances
# TODO: Replace with Redis for production multi-instance deployments
_GLOBAL_PENDING_CHALLENGES: dict[str, dict[str, Any]] = {}
...
class WebAuthnService:
    ...
    def __init__(
        ...
        # Using module-level global storage to persist across request instances
        # NOTE: self._pending_challenges now references the global dict
        self._pending_challenges = _GLOBAL_PENDING_CHALLENGES
