...
async def run_batch_processing(
    ...
    console.print(f"📊 Full summary saved to: [bold]{batch_config.output_base_dir}/batch_summary.json[/bold]")
...
Examples:
  ...
  Batch from file:
    ...
    url_group.add_argument(
        "url",
        nargs="?",
        help="WordPress URL(s) to convert (comma-separated for multiple)"
    )
    url_group.add_argument(
        "--urls-file",
