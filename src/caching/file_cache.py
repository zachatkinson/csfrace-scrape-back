...
from .base import BaseCacheBackend, CacheEntry, CacheConfig
...
class FileCache(BaseCacheBackend):
    ...
    def __init__(self, config: CacheConfig):
        ...
        for directory in [self.html_dir, self.image_dir, self.metadata_dir, 
                         self.robots_dir, self.generic_dir]:
    ...
    async def _enforce_size_limit(self) -> None:
        ...
        try:
            ...
            self.logger.info("Cache size limit exceeded, cleaning up", 
