...
class HTMLProcessor:
    ...
    def _is_external_link(self, href: str) -> bool:
        ...
        return (
            href_lower.startswith(('http://', 'https://')) and
            'csfrace.com' not in href_lower
        )
        ...
        for elem in elements_to_process:
            ...
            if elem.get('class'):
                ...
                preserved_classes = [
                    ...
                    if cls in config.preserve_classes
                ]
            ...
            if elem.get('style'):
                ...
                if not any(keep_style in style for keep_style in [
                    'aspect-ratio: 16/9',
