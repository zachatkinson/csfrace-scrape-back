...
class RobotsChecker:
    ...
    async def get_robots_parser(self, base_url: str, session: aiohttp.ClientSession) -> Optional[RobotFileParser]:
    ...
    async def can_fetch(self, url: str, user_agent: str = '*', session: aiohttp.ClientSession = None) -> bool:
    ...
    async def get_crawl_delay(self, url: str, user_agent: str = '*', session: aiohttp.ClientSession = None) -> float:
    ...
    async def enforce_crawl_delay(self, url: str, user_agent: str = '*', session: aiohttp.ClientSession = None) -> None:
